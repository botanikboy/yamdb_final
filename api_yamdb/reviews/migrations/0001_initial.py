# Generated by Django 3.2 on 2023-01-30 20:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='user', help_text='Выберите роль пользователя из списка', max_length=50, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Укажите короткое имя', unique=True, verbose_name='Короткое имя')),
            ],
            options={
                'ordering': ('name',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Укажите название', max_length=256, verbose_name='Название')),
                ('year', models.IntegerField(help_text='Укажите год', verbose_name='Год')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, help_text='Укажите дату', verbose_name='Дата')),
                ('score', models.IntegerField(help_text='Укажите оценку', validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(1)], verbose_name='Оценка')),
